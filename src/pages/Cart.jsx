  ...
  if (items.length === 0) {
    ...
    return (
      <div className='min-h-screen bg-cream flex flex-col items-center justify-center gap-6'>
        ...
        <Link
          to='/shop'
          className='font-body text-sm tracking-widest uppercase bg-gray-900 text-white px-8 py-3 hover:bg-black transition-colors duration-300'
        >
          Continue Shopping
        </Link>
      ...
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex items-center justify-between mb-10'>
          ...
          <button
            ...
            className='font-body text-xs text-gray-400 hover:text-red-500 tracking-widest uppercase transition-colors duration-200'
          >
            Clear All
          </button>
        ...
        <div className='grid lg:grid-cols-3 gap-10'>
          ...
          <div className='lg:col-span-2 flex flex-col gap-6'>
            ...
            {items.map((item, index) => (
              ...
              <div
                ...
                className='flex gap-6 bg-white p-4 border border-primary-200'
              >
          ...
          <div className='bg-white border border-primary-200 p-6 h-fit'>
            ...
            <h3 className='font-heading text-xl text-gray-900 mb-6'>
              Order Summary
            </h3>
            ...
            <Link
              to='/checkout'
              className="w-full bg-gray-900 hover:bg-black text-white font-body text-sm tracking-widest uppercase py-4 flex items-center justify-center transition-colors duration-300"
            >
              Proceed to Checkout
            </Link>
